...
#paile yo file ko name 01_dense_layer.py thiyo tara number bata start vako filename import garna namilni huna le we are changing the file name
#and here i have added if__name__=="__main__" so that this down one only runs when directly running not when imported
